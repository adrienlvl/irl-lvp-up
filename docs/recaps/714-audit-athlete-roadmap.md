...
> **A3 FAIT aux itérations 107-108, par le CONTENU et non par les pixels.** La lettre de cette roadmap disait « un seul bilan de semaine qui absorbe coach-panel et week-panel ». Mesuré, le vrai défaut n'était pas le nombre de panneaux mais le fait qu'ils ne DISAIENT PAS LA MÊME CHOSE. 107 : la cible rétrécissait en cours de semaine (6 le lundi, 4 après deux séances, puis le réglage manuel reprenait la main une fois le plan bouclé) —  est amputé de ce qui est fait, on lit désormais , et le fait est plafonné PAR CATÉGORIE (, toujours). 108 : le numérateur se comptait de deux façons — « 1 / 6 séances · il reste 5 » d'un côté, « 4/6 séances — tu es dans les temps » de l'autre, sur le même rendu. Une seule règle désormais (), les activités hors plan restant dans le grand chiffre qui dit « toute activité ». *Leçon : deux voix qui disent le même nombre peuvent rester deux panneaux ; deux panneaux qui disent deux nombres ne sont pas une redite, c'est une contradiction. La fusion utile était celle des CHIFFRES.* Reste de la lettre, non fait et assumé : la fusion de surface (week-panel reste sur Progrès, weekly-review-panel sur Corps) — elle ne rendrait des pixels qu'après B4.

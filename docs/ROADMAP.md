...
## 📍 État actuel — build 1.9.35 (2026-07-09)

App **100 % locale**, hors accès réseau **opt-in** (auto-update GitHub, re-check /3 h · sync agenda par URL · trajet auto OpenStreetMap, allowlist stricte). **143 tests + smoke** verts. Livré au-delà de la roadmap initiale (boucles #36→101) :
...
- ⚠️ Versions **1.5.2 → 1.9.35 non publiées** sur GitHub Releases (attendent un `npm run release` d'Adrien).

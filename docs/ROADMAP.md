...
## 📍 État actuel — build 1.8.9 (2026-07-09)

App **100 % locale**, hors accès réseau **opt-in** (auto-update GitHub · sync agenda par URL · trajet auto OpenStreetMap, allowlist stricte). **120 tests + smoke** verts. Livré au-delà de la roadmap initiale (boucles #36→66) :
...
- ⚠️ Versions **1.5.2 → 1.8.9 non publiées** sur GitHub Releases (attendent un `npm run release` d'Adrien).

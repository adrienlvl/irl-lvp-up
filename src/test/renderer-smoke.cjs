  ...
  try {
    ...
    const checks = await win.webContents.executeJavaScript(`(function(){
      return {
        ...
        animEngine: typeof buildAnimatedArt === 'function' && typeof ANIMATED_SHEETS === 'object' && /frame-a/.test(buildAnimatedArt('1 p0', '', 'x')) && /frame-b/.test(buildAnimatedArt('1 p0', '', 'x')),
    ...
    if (!checks.animEngine) errors.push('Moteur d’animation absent (buildAnimatedArt/ANIMATED_SHEETS/frame-a/frame-b)');

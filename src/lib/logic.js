...
function weeklyInsights(state, mondayKey, todayKey) {
  ...
  if (goalSessions > 0) {
    ...
    else out.push({ emoji: '🎯', tone: 'warn', text: `${cur.sessions}/${goalSessions} séance${goalSessions > 1 ? 's' : ''} — encore ${goalSessions - cur.sessions} pour ton objectif hebdo.` });
